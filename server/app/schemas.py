...
class TodoSchemaOptional(TodoSchema):
    title: Optional[str] = Field(min_length=1, example="Buy Milk")
    priority: Optional[int] = Field(gt=0, lt=11, default=5, example=5)
    complete: Optional[bool] = Field(False, example=False)
